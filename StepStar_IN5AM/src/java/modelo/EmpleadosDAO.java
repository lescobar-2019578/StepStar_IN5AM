...
public class EmpleadosDAO {
   ...
   public int agregar(Empleados em){
       String sql = "insert into Empleados( DPI, apellidosEmpleado, nombresEmpleado, direccionEmpleado, telefonoContacto,usuario, foto, codigoTipoEmpleado) values(?,?,?,?,?,?,?,?)";
       try{
           con = cn.Conexion();
           ps = con.prepareStatement(sql);
           ...
           ps.setBlob(7, em.getFoto());
           ps.setInt(8, em.getCodigoTipoEmpleado());
           ps.executeUpdate();
       } catch (Exception e) {
           e.printStackTrace();
       }
   ...
   public int actualizar(Empleados em){
       String sql = "update Empleados set DPI = ?, apellidosEmpleado = ?, nombresEmpleado = ?, direccionEmpleado = ?, telefonoContacto = ?,usuario = ?, foto = ? where codigoEmpleado = ?";
       try{
          con = cn.Conexion();
          ps = con.prepareStatement(sql);
          ps.setString(1, em.getDPI());
          ...
          ps.setString(6, em.getUsuario());
          ps.setBlob(7, em.getFoto());
          ps.setInt(8, em.getCodigoEmpleado());
          ps.executeUpdate();
       }catch(Exception e){
           e.printStackTrace();
       }
